...
export default function About({}: Props) {
	return (
		<div className='w-screen h-full justify-center text-center mx-auto mb-60'>
			<div className=' items-start justify-center'>
				<div className='flex flex-col space-x-4 md:flex-row md:max-w-screen-md mx-auto justify-center shrink-0'>
					<Image
						src={parrot}
						alt={"Avatar"}
						className='max-w-screen-md h-auto rounded-xl shadow-lg border border-[#ffffff, 10]'
					/>

					<div className='text-justify items-center md:max-w-screen-sm mt-4'>
					...
					<div className=' grid grid-cols-4 md:grid-cols-2 md:grid-rows-7 md:self-center m-4 fill-[rgba(255,255,255,0.5)] content-center items-end place-items-center space-y-4 md:space-x-2 shrink-0'>
						<svg
			...
			<div className='items-start justify-center space-y-4 my-4'>
