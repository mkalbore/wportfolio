...
/////////////////////
import image1 from "../../public/BoiskoMentalne.png";
import image2 from "../../public/trix.png";
import image3 from "../../public/asp.png";
...
export class ItemClass {
	...
	constructor() {
		this.items = [
			{
				title: "Boisko Mentalne",
				description:
					"Visionary project that combines two elements: soccer/football and mental development. A modern, minimalist logo while maintaining the general idea of the entire project.",
				photoSrc: image1,
				link: "",
			},
			{
			...
			{
				title: "ASP",
				description: "ASP - Akademia Sportowa, local basketball team logo.",
				photoSrc: image3,
				link: "",
			},
...
export default function AccordionServicesLogo({
	category,
	linksareavailable,
}: Props) {
