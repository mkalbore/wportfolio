	...
	return (
		<div className='w-screen h-screen justify-center text-center flex flex-col space-y-10 mb-20'>
			...
			<div>
				...
				<h2 className='font-normal underline'>quint.biuro@gmail.com</h2>
			</div>
			<div>
				<h2 className=''>Call me:</h2>
				<h2 className='font-normal'>123 45 67 89</h2>
			</div>
			<div>
				<h2 className='font-normal'>Find me on web:</h2>
				<div className='flex flex-row w-auto h-10 space-x-10 my-2 fill-[rgba(255,255,255,0.5)] relative justify-center '>
					<svg
