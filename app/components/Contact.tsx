		...
		<div className='max-w-screen-md h-screen justify-center text-center flex flex-col space-y-10 mb-20 mx-auto'>
			...
			<div>
				...
				<div className='flex flex-row w-auto h-10 lg:h-14 space-x-4 md:space-x-10 my-10  lg:my-12 dark:fill-secondary-dark relative justify-center'>
					...
					<Link href={"https://twitter.com/MarekKwinta_"} className='group'>
						<svg
							className='hidden group-hover:flex w-[40px] h-[40px] lg:h-[60px] lg:w-[60px] dark:fill-[rgba(255,255,255,0.5)] dark:hover:fill-[rgba(255,255,255,1)] hover:fill-secondary-dark active:scale-105 transition-all ease-out duration-300 cursor-pointer'
							role='img'
							viewBox='0 0 24 24'
							xmlns='http://www.w3.org/2000/svg'>
							<title>X</title>
						...
						<svg
							className='flex group-hover:hidden w-[40px] h-[40px] lg:h-[60px] lg:w-[60px] dark:fill-[rgba(255,255,255,0.5)] dark:hover:fill-[rgba(255,255,255,1)] hover:fill-secondary-dark active:scale-105 transition-all ease-out duration-300 cursor-pointer'
							role='img'
							viewBox='0 0 24 24'
							xmlns='http://www.w3.org/2000/svg'>
							<title>Twitter</title>
