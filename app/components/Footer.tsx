		...
		<div className='flex justify-between p-8 items-center bg-primary-light dark:bg-primary-dark text-font-light-mode dark:text-font-dark-mode'>
			...
			<div className='hidden md:flex flex-row w-auto h-8 space-x-10 fill-secondary-dark justify-end'>
				...
				<div className='group hidden md:flex flex-row fill-secondary-dark justify-end'>
					<svg
						className='hidden group-hover:flex hover:fill-[rgba(255,255,255,1)] transition-all ease-in-out duration-1000 cursor-pointer'
						role='img'
						viewBox='0 0 24 24'
						xmlns='http://www.w3.org/2000/svg'>
						<title>X</title>
					...
					<svg
						className='flex group-hover:hidden hover:fill-[rgba(255,255,255,1)] transition-all ease-in-out duration-1000 cursor-pointer'
						role='img'
						viewBox='0 0 24 24'
						xmlns='http://www.w3.org/2000/svg'>
						<title>Twitter</title>
				...
				<Link href='/' className=''>
					<svg
						...
						viewBox='0 0 24 24'
						id={"back_to_menu"}
						className='h-10 fill-font-light-mode dark:fill-font-dark-mode opacity-20 hover:fill-font-light-mode dark:hover:fill-font-dark-mode hover:opacity-100 hover:scale-105 active:scale-110 transition duration-300 ease-out cursor-pointer select-none z-30'>
