							...
							<AlertDialog>
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											If there are any spelling mistakes, I apologize. If you
											have any questions/observations, please write to me.
										</AlertDialogDescription>
									</AlertDialogHeader>
									<AlertDialogFooter>
						...
						<div className='transition ease-out duration-600 hover:font-normal'>
							...
							<AlertDialog>
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										<AlertDialogTitle>
											Przepraszamy, ale strona nie posiada obecnie tłumaczenia
											na język polski.
										</AlertDialogTitle>
										<AlertDialogDescription>
						...
						<div className='transition ease-out duration-600 hover:font-normal'>
							...
							<AlertDialog>
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										<AlertDialogTitle>
											Je nám líto, ale stránka momentálně nemá překlad do
											češtiny.
										</AlertDialogTitle>
										<AlertDialogDescription>
